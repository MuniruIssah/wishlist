...
const LoginForm = () => {
  return (
   <Formik initialValues={initialValues} validationSchema={validationSchema} validateOnChange>
      {(formik) => (
        <Form className="flex flex-col mt-3 w-full">
          <h2 className="font-bold text-gray-800 text-4xl mb-4 drop-shadow-sm ">Login</h2>
